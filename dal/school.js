...
exports.GetSchoolByName = function(name, callback) {
    console.log(name);
    var query = 'SELECT * FROM school WHERE name=\'' + name + "'";
    console.log(query);
...
exports.Insert = function(school_info, callback) {
     ...
     */
    var dynamic_query = 'INSERT INTO school (name, street, city, state, zip) VALUES (' +
        '\'' + school_info.Title + '\', ' +
        '\'' + school_info.Street + '\', ' +
        '\'' + school_info.City + '\', ' +
        '\'' + school_info.State + '\', ' +
